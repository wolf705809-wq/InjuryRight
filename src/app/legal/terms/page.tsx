...
export const metadata: Metadata = {
  ...
  description: 'Terms and conditions for using WorkerRight.',
}
      ...
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-8">
          <p className="text-amber-800 text-sm font-medium">
            WorkerRight is not a law firm. We do not provide legal advice. Use of this site does not create an attorney-client relationship. Always consult a licensed attorney for legal advice specific to your situation.
          </p>
        </div>
        ...
        <div className="space-y-8 text-sm text-gray-600 leading-relaxed">
          <section>
            ...
            <p>By accessing or using WorkerRight ("the Site"), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the Site.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-gray-800 mb-3">2. Description of Services</h2>
            <p className="mb-3">WorkerRight provides:</p>
          ...
          <section>
            ...
            <p>
              WorkerRight and its operators shall not be liable for any damages arising from your use of the Site, including but not limited to reliance on compensation estimates, failure to file claims within statutory deadlines, or outcomes of legal proceedings. Use of the Site is at your own risk.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              You agree to indemnify and hold harmless WorkerRight, its operators, employees, and partners from any claims, damages, or expenses arising from your use of the Site or violation of these Terms.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              All content on this Site, including text, graphics, logos, and code, is the property of WorkerRight or its licensors and is protected by applicable intellectual property laws. You may not reproduce or distribute content without written permission.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              These Terms shall be governed by the laws of the United States and the state in which WorkerRight is incorporated, without regard to conflict of law principles.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Questions about these Terms should be directed to: legal@getfairclaimpro.com
            </p>
          </section>
        </div>
      </div>
